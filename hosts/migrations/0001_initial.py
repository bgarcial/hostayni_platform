# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-10-29 23:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.CharField(blank=True, max_length=255, null=True, verbose_name='latitude')),
                ('longitude', models.CharField(blank=True, max_length=255, null=True, verbose_name='longitude')),
                ('institute_character', models.CharField(choices=[('Privada', 'Privada'), ('Pública', 'Pública'), ('Privada - Pública', 'Privada - Pública')], max_length=20, verbose_name='Caracter de la institución')),
