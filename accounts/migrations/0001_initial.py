    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+$', 'Enter a valid username.', 'invalid')], verbose_name='username')),
                ...
                ('is_entrepreneurship_host', models.BooleanField(default=False, verbose_name='Anfitrión de emprendimiento')),
                ('is_hosting_host', models.BooleanField(default=False, verbose_name='Anfitrión de alojamiento')),
                ('is_ayni_host', models.BooleanField(default=False, verbose_name='Anfitrión AYNI')),
                ('is_daily_life_host', models.BooleanField(default=False, verbose_name='Anfitrión de servicios de vida diaria')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slug', models.SlugField(blank=True, max_length=100)),
                ('enterprise_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Compañía con la cual esta vinculado')),
                ('innovation_topics_choice', models.CharField(blank=True, max_length=255, null=True, verbose_name='Areas de innovación de su elección')),
                ('educational_titles', models.CharField(blank=True, max_length=255, null=True, verbose_name='Títulos educativos')),
                ('complete_studies_school', models.CharField(blank=True, max_length=255, null=True, verbose_name='Institución en donde terminó sus estudios anteriores')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origin_education_school', models.CharField(blank=True, max_length=128, null=True, verbose_name='Institución de educación de origen')),
                ('current_education_school', models.CharField(blank=True, max_length=128, null=True, verbose_name='Institución educativa en la cual está vinculado en su actual lugar residencia')),
                ('educational_titles', models.CharField(blank=True, max_length=255, null=True, verbose_name='Títulos educativos')),
                ('complete_studies_school', models.CharField(blank=True, max_length=255, null=True, verbose_name='Institución en donde terminó sus estudios anteriores')),
                ('knowledge_topics_choice', models.CharField(blank=True, max_length=255, null=True, verbose_name='Areas de conocimiento de su elección')),
                ('research_groups', models.CharField(blank=True, max_length=255, verbose_name='Grupos de Investigación a los que pertenece')),
                ('autorship_publications', models.CharField(blank=True, max_length=255, verbose_name='Publications of its authorship')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origin_education_school', models.CharField(blank=True, max_length=128, null=True, verbose_name='Institución de educación de origen')),
                ('current_education_school', models.CharField(blank=True, max_length=128, null=True, verbose_name='Institución educativa en la cual está vinculado en su actual lugar residencia')),
                ('extra_occupation', models.CharField(blank=True, max_length=128, null=True, verbose_name='Ocupación Extra')),
                ('educational_titles', models.CharField(blank=True, max_length=255, null=True, verbose_name='Titulos Educativos')),
                ('complete_studies_school', models.CharField(blank=True, max_length=255, null=True, verbose_name='Institución en donde completó sus estudios anteriores')),
                ('knowledge_topics_choice', models.CharField(blank=True, max_length=255, null=True, verbose_name='Áreas de conocimiento de su elección')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
