$(document).ready(function(i) {
    ...
    }), i("form #id_email").attr("placeholder", "Correo"), i("form #id_password1").attr("placeholder", "Contraseña"), i("form #id_password2").attr("placeholder", "Repetir contraseña"), i("form #id_username").attr("placeholder", "Nombre de usuario"), i("form #id_password").attr("placeholder", "Contraseña")
});